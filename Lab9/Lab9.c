    ...
    while(bottom < top && !sorted) {
        ...
        if (goingUp) {
            for(i = bottom; i < top; i++) {
                ...
                shouldSwap = false;
            if (strcmp (library [i].artist, library [i+1]. artist) > 0 || ( strcmp(library [i].artist, library [i+1]. artist) == 0 && strcmp(library [i].songName, library [i+1].songName) > 0))
                    shouldSwap = true;
            ...
            for (i = top; i > bottom; i--) {
              ...
              shouldSwap = false;
            if (strcmp (library [i-1].artist, library [i]. artist) > 0 || ( strcmp(library [i-1].artist, library [i]. artist) == 0 && strcmp(library [i-1].songName, library [i].songName) > 0))
                shouldSwap = true;
